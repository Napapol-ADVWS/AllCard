...
import { Text, View, TextInput, TouchableOpacity, Image,TouchableWithoutFeedback,Keyboard } from 'react-native';
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: '#182e68' }}>
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={{ alignItems: 'center' }}>
                        <TouchableOpacity style={StyleSheet.buttonLogin} onPress={this.Goto}>
